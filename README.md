...
To view the change log and the features in the latest version please check "releases" on the github page.
...
1. Make a backup of the engines.cfg, target_performance.cfg and flight_model.cfg in the folder:
